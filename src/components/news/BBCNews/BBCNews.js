...
class BBCNews extends Component {
    state = {
        news: [],
        heading: 'Top Headlines From BBC News',
        id: uuid()
    }

    componentDidMount() {
        axios.get('https://newsapi.org/v2/top-headlines?sources=bbc-news&pageSize=24&apiKey=0fb4e3906e844d25a06d3bcb65fceb49')
            .then(res => {
